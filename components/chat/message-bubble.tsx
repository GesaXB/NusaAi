...
export function MessageBubble({ message, isStreaming }: MessageBubbleProps) {
  ...
  return (
    <motion.div
      ...
      layout
      className={cn(
        "flex gap-3 sm:gap-4 group w-full",
    ...
    >
      ...
      <div className="flex-shrink-0 mt-1">
        {isUser ? (
          ...
          <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-2xl bg-white border border-zinc-100 flex items-center justify-center overflow-hidden shadow-sm ring-4 ring-zinc-50/50">
            <Image src="/logo.png" alt="NusaAI" width={20} height={20} className="object-contain" />
          </div>
        )}
      </div>
      ...
      <div
        className={cn(
          "max-w-[85%] sm:max-w-[80%] rounded-[24px] px-4 sm:px-6 py-3 sm:py-4 text-[15px] leading-relaxed relative",
...
export function TypingIndicator() {
  return (
    ...
    >
      ...
      <div className="bg-white border border-zinc-100/80 rounded-[24px] rounded-tl-none px-6 py-4 shadow-sm flex items-center">
